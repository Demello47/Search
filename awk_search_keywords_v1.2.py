...
#
# With tail extraction:
#
#     #...
#
#     Keeps the matched keyword/regex text and everything after it.
...
with open(
    ...
    for line in f:
        ...
        if "#" in line:
            ...
            #
            # Input line:
            # 2026-09-14 INFO something python script.py --test
            #
            # Saved text:
            # python script.py --test
            # --------------------------------------------------

            if options_part.strip() == "...":
                tail = True
                ...
                if not match:
                    ...
                    print(
                        'Examples: TEST_STAGE #" ",5,6   OR   python #...'
                    )
...
# ==========================================================
# EXTRACT FROM MATCH TO END OF LINE
#
# Literal example:
#     python #...
#
